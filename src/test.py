...
class TestAppRoutes(unittest.TestCase):
    ...
    def test_show_next_tr_route_incorrect_solution_score_no_increase(self):
        self.log_test_start(
            "test_show_next_tr_route_incorrect_solution_score_no_increase"
        )
        global tr_score
        tr_score = 0
        response = self.app.get("/time-race/incorrect_solution_id")
    ...
    def test_store_result_route_correct_solution_increase_rounds_won(self):
        self.log_test_start(
            "test_store_result_route_correct_solution_increase_rounds_won"
        )
        global rounds_won
        global rounds_lost
        rounds_won = 1
    ...
    def test_store_result_route_incorrect_solution_increase_rounds_lost(self):
        self.log_test_start(
            "test_store_result_route_incorrect_solution_increase_rounds_lost"
        )
        global rounds_won
        global rounds_lost
        rounds_won = 0
